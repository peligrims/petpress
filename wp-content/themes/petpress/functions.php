<?php
/**
 * petpress functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package petpress
 */
 require_once get_template_directory() . '/Petpress_Header_Menu.php';

if ( ! function_exists( 'petpress_setup' ) ) :
	/**
	 ...
	 */
	function petpress_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on petpress, use a find and replace
		 * to change 'petpress' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'petpress', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'header-menu' => esc_html__( 'Header Menu', 'petpress' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'petpress_custom_background_args', array(
...
add_action( 'after_setup_theme', 'petpress_setup' );
 ...
 */
function petpress_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'petpress_content_width', 640 );
}
add_action( 'after_setup_theme', 'petpress_content_width', 0 );
 ...
 */
function petpress_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'petpress' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'petpress' ),
...
add_action( 'widgets_init', 'petpress_widgets_init' );
...
function petpress_scripts() {
    ...
    wp_enqueue_style( 'petpress-owl-carousel', get_template_directory_uri() . '/assets/css/owl.carousel.min.css' );
    wp_enqueue_style( 'petpress-owl-theme-default', get_template_directory_uri() . '/assets/css/owl.theme.default.min.css' );
    wp_enqueue_style( 'petpress-flexslider', get_template_directory_uri() . '/assets/css/flexslider.css' );
    wp_enqueue_style( 'petpress-theme', get_template_directory_uri() . '/assets/css/style.css' );
    wp_enqueue_style( 'petpress-custom', get_template_directory_uri() . '/assets/css/petpress.css' );

    wp_enqueue_script( 'petpress-modernizr-js', get_template_directory_uri() . '/assets/js/modernizr-2.6.2.min.js' );
    wp_enqueue_script( 'petpress-respond-js', get_template_directory_uri() . '/assets/js/respond.min.js' );
    wp_script_add_data('petpress-respond-js', 'conditional', 'lt IE 9');
