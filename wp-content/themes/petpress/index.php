...
<div class="page1_block">
    <div class="container_12">
        <div class="grid_6">
            ...
            <br>
            <img src="<?php echo get_template_directory_uri() ?>/assets/images/page1_img5.jpg" alt="" class="img_inner fleft">
...
<div class="content page1">
    <div class="container_12">
        ...
        <div class="clear"></div>
        <ul class="carousel1">
            <li class="grid_4"> <img src="<?php echo get_template_directory_uri() ?>/assets/images/carousel1_img1.jpg" alt="" class="img_inner fleft">
            ...
            <li class="grid_4"> <img src="<?php echo get_template_directory_uri() ?>/assets/images/carousel1_img2.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper pad1">
            ...
            <li class="grid_4"> <img src="<?php echo get_template_directory_uri() ?>/assets/images/carousel1_img3.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper pad1">
            ...
            <li class="grid_4"> <img src="<?php echo get_template_directory_uri() ?>/assets/images/carousel1_img4.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper pad1">
                    <p class="col2"><a href="#">Aeraesent quis hoj rcieget diam iverral.</a></p>
                    Loaesent quis orci diam viverralopr con equat. Lusce sagittis quam ihui hyhy opir pulvinarhjk velit. </div>
            </li>
            <li class="grid_4"> <img src="<?php echo get_template_directory_uri() ?>/assets/images/carousel1_img5.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper pad1">
                    <p class="col2"><a href="#">Aeraesent quis hoj rcieget diam iverral.</a></p>
                    Loaesent quis orci diam viverralopr con equat. Lusce sagittis quam ihui hyhy opir pulvinarhjk velit. </div>
            </li>
            <li class="grid_4"> <img src="<?php echo get_template_directory_uri() ?>/assets/images/carousel1_img6.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper pad1">
                    <p class="col2"><a href="#">Aeraesent quis hoj rcieget diam iverral.</a></p>
                    Loaesent quis orci diam viverralopr con equat. Lusce sagittis quam ihui hyhy opir pulvinarhjk velit. </div>
            </li>
...
<div class="bottom_block">
    <div class="container_12">
        ...
        <div class="grid_4 prefix_2">
            ...
            <img src="<?php echo get_template_directory_uri() ?>/assets/images/page1_img4.jpg" alt="" class="fleft img_inner">
            <div class="extra_wrapper">
